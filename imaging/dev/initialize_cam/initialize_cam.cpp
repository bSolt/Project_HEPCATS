//=============================================================================
//  Essentially this  just  initizlizes the camera, sets exposures, imaging 
//  settings and a bunch of other shit then deinitializes the camera
//=============================================================================
...
spinError ConfigureExposure(spinNodeMapHandle hNodeMap)
{
    ...
    double exposureTimeMax = 2000000.0;
